...
Path = 'MachineLearning-Portfolio/3-Classification/   /bin/Social_Network_Ads.csv'
BinPath = 'MachineLearning-Portfolio/3-Classification/   /bin'
...
ggsave("_Training_R.png",  path = BinPath)
...
points(grid_set, pch = '.', col = ifelse(y_grid == 1, 'springgreen3', 'tomato'))
points(set, pch = 21, bg = ifelse(set[, 3] == 1, 'green4', 'red3'))
ggsave("_Testing_R.png",  path = BinPath)