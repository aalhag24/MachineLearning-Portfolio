...
BinPath = 'MachineLearning-Portfolio/3-Classification/7-Random_Forest_Classification/bin'
...
ggsave(file="Random Forest_Training_R.png", plot=TrainingPlot, path=BinPath)
...
points(grid_set, pch = '.', col = ifelse(y_grid == 1, 'springgreen3', 'tomato'))
points(set, pch = 21, bg = ifelse(set[, 3] == 1, 'green4', 'red3'))
ggsave(file="RandomForest_Testing_R.png", plot=TestingPlot, path = BinPath)