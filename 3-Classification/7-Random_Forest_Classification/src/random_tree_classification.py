...
# Feature Scaling
# Not nessessary when using non-Eclidian Distance Classification
# But it will run faster with Feature Scaling
sc_X = StandardScaler()
...
TrainingPlot.savefig(BinPath + '\RandomForest_Training_PY.png')
...
TestingPlot.savefig(BinPath + '\RandomForest_Testing_PY.png')